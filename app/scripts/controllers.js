...
angular.module('thebestdoctorsfriend')
    .controller('addpatientsController', ['$scope', 'patientFactory', 'AuthFactory', function ($scope, patientFactory, AuthFactory) {
        ...
        if (!AuthFactory.isAuthenticated()) {
            ...
            $scope.sendPatient = function () {
                ...
                toastr.success('The patient was saved successfully', 'Add Patients');
